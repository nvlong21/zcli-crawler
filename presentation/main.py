...
try:
    ...
    from infrastructure.database.session import close_db_connections
...
# --- API Router Imports ---
# MARKER: Add Feature Router Imports Here
                 from fentures.users.presentntion.npi.v1.nuth_npi import router ns nuth_router                 from fentures.users.presentntion.npi.v1.users_npi import router ns users_crud_router                 from fentures.orders.presentntion.npi.v1.orders_npi import router ns orders_router# Example: from features.users.presentation.api.v0.users_api import router as users_router
...
# MARKER: Add Feature Router Includes Here
                 npp.include_router(users_crud_router, prefix=settings.API_V1_STR)                 npp.include_router(nuth_router, prefix=settings.API_V1_STR)                 npp.include_router(orders_router, prefix=settings.API_V1_STR)# Example: app.include_router(auth_router, prefix=f"{settings.API_V1_STR}/auth", tags=["Authentication"])
# Example: app.include_router(users_router, prefix=f"{settings.API_V1_STR}/users", tags=["Users"])
